...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <tr>
        <td>Bon Adriel Aseniero, Tiffany Wun, David Ledo, Guenther Ruhe, Anthony Tang, and Sheelagh Carpendale. 2015. STRATOS: Using Visualization to Support Decisions in Strategic Software Release Planning. In Proceedings of the 33rd Annual ACM Conference on Human Factors in Computing Systems (CHI '15). ACM, New York, NY, USA, 1479-1488. <a href="https://dl.acm.org/citation.cfm?id=2702426">(pdf)</a> <a href="https://www.youtube.com/watch?v=CKwwwIh5y_I">(video preview)</a></td>
        <td><b>Bruno e Nayana</b></td>
      </tr>
    </tbody>
</table>
...
* Lucas e Cayk: Explaining the Gap: Visualizing One's Predictions Improves Recall and Comprehension of Data
* Elias e Émerson: Stardust: Accessible and Transparent GPU Support for Information Visualization Rendering
* Nécio e Douglas: Same Stats, Different Graphs: Generating Datasets with Varied Appearance and Identical Statistics through Simulated Annealing

### Dia 29/11 - Quarta-feira

* Anderson e Maurício: Timelines Revisited: A Design Space and Considerations for Expressive Storytelling
* Eduardo e Felipe: Modeling Color Difference for Visualization Design
* Adriando e Pedro Paiva: Visualizing Dynamic Bitcoin Transaction Patterns

### Dia 04/12 - Segunda-feira

* Bruno e Nayana: STRATOS: Using Visualization to Support Decisions in Strategic Software Release Planning
* Lucas Leite e Rafael: Visualizing Nonlinear Narratives with Story Curves 
* Alexandre e Arnaldo: An Empirical Study on the Reliability of Perceiving Correlation Indices using Scatterplots